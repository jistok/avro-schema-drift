...
(LIKE public.crimes)
EXECUTE '$HOME/go-kafkacat-avro --avro=true --broker=localhost:9092 consume --group=GPDB_Consumer_Group crimes_avro --eof 2>>$HOME/`printf "kafka_consumer_%02d.log" $GP_SEGMENT_ID`'
